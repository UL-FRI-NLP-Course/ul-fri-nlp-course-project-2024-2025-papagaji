...
data_collator = DataCollatorWithPadding(tokenizer=tokenizer, pad_to_multiple_of=8)  # optional: pad_to_multiple_of for faster GPU
...
trainer.save_model("gams9b-finetuned_1")
